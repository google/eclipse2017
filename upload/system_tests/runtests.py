...
def _build_tests(output_file):
    ...
    docker_cmd = [
        ...
        '--no-cache',
        '-t',
        'gcr.io/google.com/eclipse-north-america-2017/upload-system-tests',
        '.'
    ]
    gcloud_cmd = [
        'gcloud',
    ...
    os.chdir(TEST_DIR)
    return _run_cmds((tar_cmd, docker_cmd, gcloud_cmd), output_file)


def _deploy(output_file):
    kube_cmd = [
        'kubectl',
        'create',
        '-f',
    ...
    print "Deploying test to kubernetes..."

    os.chdir(os.path.dirname(SERVER_DIR))
